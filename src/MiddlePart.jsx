...
const MiddlePart = () => {
  ...
  <span className="secondary-text"> Connect, Earn, and Grow</span>
    ...
    <div className="description"></div>
            ...
            <div className='cta-provider'>Sign up for early access to MedxBay and get an exclusive pre-launch offer for the first 100 providers!</div>
            <button className='pop-up-button' onClick={ handleShowPopupProviders}>Know More</button>
  ...
  <span className="secondary-text"> Own Health Advocate</span>
            ...
            <div className='cta-patient'>Sign up to get notified about our launch and enjoy free patient profiles!</div>
             <div className="btn-div">
                <button className='pop-up-button' onClick={handleShowPopup}>Know More</button>
              </div>
          </div>
